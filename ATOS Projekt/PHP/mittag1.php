<div class="row g-3" id="mittag">
  ...
  <div class="col-md-6">
    ...
    <div>
      <h6>Vorspeise</h6>
      <i>Tomaten-Consommé</i>
    </div>
    <br>
    <div>
      <h6>Aktiv vegetarisch</h6>
      <i>Spinatknödel mit Käsesauce und Salat</i>
    </div>
    <br>
    <div>
      <h6>Der Küchenchef empfiehlt</h6>
      <i>Putengeschneltes "Züricher Art" mit frischen Champignons im Reisrand</i>
    </div>
    <br>
    <div>
      <h6>Köstlich bewährt</h6>
      <i>Mangold-Linsen-Curry</i>
    </div>
    <br>
    <div>
      <h6>Dessert</h6>
      <i>Stracciatella-Quark mit Kirschkompott</i>
    </div>
  </div>
</div>
