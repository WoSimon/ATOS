<div class="row g-3" id="mittag">
          ...
          <div class="col-md-6">
            ...
            <div>
              <h6>Vorspeise</h6>
              <i>Brokkolicremesuppe</i>
            </div>
            <br>
            <div>
              <h6>Aktiv vegetarisch</h6>
              <i>Grillkartoffel gefüllt mit Tomate und Schaftskäse dazu Kräuterschmand</i>
            </div>
            <br>
            <div>
              <h6>Der Küchenchef empfiehlt</h6>
              <i>Frikasse von Huhn mit Spargel, Champignons und Risi-Bisi</i>
            </div>
            <br>
            <div>
