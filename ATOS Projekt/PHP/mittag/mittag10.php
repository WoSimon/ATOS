<div class="row g-3" id="<?php echo $tag . '-'?>mittag">
  ...
  <div class="col-md-6">
    ...
    <div>
      ...
      <i>Gefüllte Zuchini mit Gemüse-Couscous</i>
    </div>
    <br>
    <div>
      <h6>Der Küchenchef empfiehlt</h6>
      <i>Putenfilet in frischer Champignonrahmsauce und Kartoffelpüree</i>
    </div>
    <br>
    <div>
      <h6>Köstlich bewährt</h6>
      <i>Großer gemischter Salatteller mit Schaftskäse und Grissini</i>
    </div>
    <br>
    <div>
      <h6>Dessert</h6>
