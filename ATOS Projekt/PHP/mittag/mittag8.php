<div class="row g-3" id="mittag">
  ...
  <div class="col-md-6">
    ...
    <div>
      ...
      <i>Agnolotti mit Ricotta und Trüffel in Kirschtomate und Butter geschwenkt</i>
    </div>
    <br>
    <div>
      <h6>Der Küchenchef empfiehlt</h6>
      <i>Hänchengeschnetzeltes in Kokos-Curry-Sauce mit Dufreis und geröstete Kürbiskerne</i>
    </div>
    <br>
    <div>
      <h6>Köstlich bewährt</h6>
      <i>Sellerieschnitzel in Parmesanhülle mit Dip und gemischtem Salat</i>
    </div>
    <br>
    <div>
      <h6>Dessert</h6>
      <i>Orangen-Vanille-Quark</i>
    </div>
  </div>
</div>
