<div class="row g-3" id="<?php echo $tag . '-'?>mittag">
  ...
  <div class="col-md-6">
    ...
    <div>
      ...
      <i>Blattsalat mit gebratenen Pilzen und Baguette</i>
    </div>
    <br>
    <div>
      <h6>Der Küchenchef empfiehlt</h6>
      <i>Frischer Stangenspargel mit zerlassener Butter, salzkartoffeln und gemischter Schinken</i>
    </div>
    <br>
    <div>
      <h6>Köstlich bewährt</h6>
      <i>Pfannengemüse mit Rosmarinkartoffeln und Kräuterdip</i>
    </div>
    <br>
    <div>
      <h6>Dessert</h6>
      <i>Bunter Obstsalat mit Schmand</i>
    </div>
  </div>
</div>
