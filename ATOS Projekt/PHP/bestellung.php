    ...
    <form class="row g-3" method="POST">
        <div class="row g-3" id="frühstück">
            ...
            <div class="col-md-6">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="extrasFrüh" id="extrasFrüh" onchange="zeigeFrückstückExtras()">
                    <label class="form-check-label" for="extrasFrüh">Extras</label>
                </div>
                <div id="optionenExtrasFrüh" style="display: none;">
        ...
        <div class="row g-3" id="abend">
            ...
            <div class="col-md-6">
                <h4>Abendessenbestellung</h4>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="<?php echo $tag . '-'?>abend" onchange="zeigeAbendSpezifikationen()" id="basicAbend" required>
                        <label class="form-check-label" for="basicAbend">Basic</label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="<?php echo $tag . '-'?>abend" onchange="zeigeAbendSpezifikationen()" id="vegetarischAbend">
                        <label class="form-check-label" for="vegetarischAbend">Vegetarisches Abendessen</label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="<?php echo $tag . '-'?>abend" onchange="zeigeAbendSpezifikationen()" id="salatAbend">
                        <label class="form-check-label" for="salatAbend">Salatauswahl</label>
                    </div>
                    <div id="salatAuswahl" style="display:none;">
                        <div class="form-check offset-sm-1">
                            <input class="form-check-input" type="radio" name="<?php echo $tag . '-'?>salat" id="salatHächen" value="salatHächen">
                            <label class="form-check-label" for="salatHächen">Hänchenbrustfilet</label>
                        </div>
                        <div class="form-check offset-sm-1">
                            <input class="form-check-input" type="radio" name="<?php echo $tag . '-'?>salat" id="salatFeta" value="salatFeta">
                            <label class="form-check-label" for="salatFeta">Feta</label>
                        </div>
                        <div class="form-check offset-sm-1">
                            <input class="form-check-input" type="radio" name="<?php echo $tag . '-'?>salat" id="salatThunfisch" value="salatThunfisch">
                            <label class="form-check-label" for="salatThunfisch">Thunfisch</label>
                        </div>
                        <div class="form-check offset-sm-1">
                            <input class="form-check-input" type="radio" name="<?php echo $tag . '-'?>salat" id="salatGouda" value="salatGouda">
                            <label class="form-check-label" for="salatGouda">Goudastreifen</label>
                        </div>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="<?php echo $tag . '-'?>abend" onchange="zeigeAbendSpezifikationen()" id="wrapAbend">
                        <label class="form-check-label" for="wrapAbend">Wrap</label>
                    </div>
                    <div id="wrapAuswahl" style="display:none;">
                        <div class="form-check offset-sm-1">
                            <input class="form-check-input" type="radio" name="<?php echo $tag . '-'?>wrap" id="wrapVegi" value="wrapVegi">
                            <label class="form-check-label" for="wrapVegi">Vegetsrisch</label>
                        </div>
                        <div class="form-check offset-sm-1">
                            <input class="form-check-input" type="radio" name="<?php echo $tag . '-'?>wrap" id="wrapPute" value="wrapPute">
                            <label class="form-check-label" for="wrapPute">mit Pute</label>
                        </div>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="<?php echo $tag . '-'?>abend" onchange="zeigeAbendSpezifikationen()" id="capreseAbend">
                        <label class="form-check-label" for="capreseAbend">Caprese</label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="<?php echo $tag . '-'?>abend" onchange="zeigeAbendSpezifikationen()" id="suppeAbend">
                        <label class="form-check-label" for="suppeAbend">Suppe</label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="extrasAbend" id="extrasAbend" onchange="zeigeAbendExtras()">
                        <label class="form-check-label" for="extrasAbend">Extras</label>
                    </div>
                    <div id="extrasAbendTxt" style="display: none;">
                        <div class="form-floating">
                            ...
                            <label for="extrasAbend-txt">Hier können Sie Anmerkungen und Extras für Ihr Abendessen eintragen</label>
                        </div>
                    </div>
                </div>
